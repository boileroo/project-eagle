...
Currently, matchplay is only available as a "Team Match" — requiring teams to be configured. Two players in a round together (not as part of teams) should still be able to play matchplay against one another. Similarly, four players in a group could play pairs matchplay, or two separate matches 1v1.
