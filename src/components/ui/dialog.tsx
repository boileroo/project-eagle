  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 fixed top-[2%] left-[50%] z-50 grid max-h-[96dvh] w-full max-w-[calc(100%-1rem)] translate-x-[-50%] gap-4 overflow-y-auto rounded-3xl border border-white/5 p-6 shadow-2xl duration-200 outline-none sm:top-[50%] sm:max-h-[calc(100dvh-4rem)] sm:max-w-lg sm:translate-y-[-50%] md:p-8',
          className,
        )}
        {...props}
      >
